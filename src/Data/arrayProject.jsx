...
import ImgDarkMinesweeper from "/assets/images/projects/DarkMinesweeper.webp";
...
const arrayProject = [
  ...
  {
    imageSrc: ImgDarkMinesweeper,
    title: "Dark Minesweeper",
    description: `Uma recriação do clássico jogo Campo Minado (Minesweeper) feita em 
        React + TypeScript, com foco em código organizado, boas práticas e uma interface moderna.
        O jogo conta com diversas funcionalidades, incluindo a possibilidade de escolher
        entre três níveis de dificuldade: Fácil (9x9 com 10 minas), Médio (16x16 com 40 minas) e
        Difícil (30x16 com 99 minas). Ele possui um contador que exibe o número de minas restantes,
        um timer para medir o tempo de jogo e apresenta condições de vitória e derrota acompanhadas
        por um overlay animado. Além disso, a interface é responsiva e estilizada utilizando 
        TailwindCSS.
`,
    linkRepo: "https://github.com/TheBestGekyume/DarkMinesweeper",
    linkSite: "https://darkminesweeper.netlify.app/",
    icons: getIcons(["HTML5", "CSS3", "Sass", "JavaScript", "Bootstrap"]),
    highlight: true,
  },
  {
